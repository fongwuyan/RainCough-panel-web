...
export const api = {
  ...
  rcBrowse: (path) => req('GET', `/api/plugins/raincode/workspace/browse?path=${encodeURIComponent(path || '')}`),
  rcMemory: () => req('GET', '/api/plugins/raincode/memory'),
  rcMemorySave: (content) => req('POST', '/api/plugins/raincode/memory', { content }),
  rcStart: () => req('POST', '/api/plugins/raincode/start', {}),
  rcStop: () => req('POST', '/api/plugins/raincode/stop', {}),
  rcSessions: (workspace) => req('GET', '/api/plugins/raincode/sessions' + (workspace ? '?workspace=' + encodeURIComponent(workspace) : '')),
  ...
  rcProviders: () => req('GET', '/api/plugins/raincode/providers'),
  rcProvidersSave: (providers, defaultProvider) => req('POST', '/api/plugins/raincode/providers', { action: 'save', providers, default_provider: defaultProvider }),
  rcProviderDelete: (name) => req('POST', '/api/plugins/raincode/providers', { action: 'delete', name }),
  rcModels: (provider) => req('GET', `/api/plugins/raincode/models?provider=${encodeURIComponent(provider || '')}`),
  rcPrinciples: () => req('GET', '/api/plugins/raincode/principles'),
  rcPrinciplesSave: (principles) => req('POST', '/api/plugins/raincode/principles', { principles }),
