...
${codeFrame}` : message);
  ...
  // plugins/texttool/frontend/plugin.js
  var NAME = "texttool";
  function mount(container, ctx) {
    const App = {
      data() {
        return { tab: "regex", err: "", out: "", pattern: "", text: "", flags: 0, find: "", repl: "", rx: false, content: "", act: "json2yaml" };
      },
      methods: {
      ...
      render() {
        ...
        const views = {
          ...
          stats: h("div", null, [
            h("button", { class: "btn", style: "margin-bottom:6px;", onclick: () => this.run("texttool.stats", { content: this.content }) }, "\u7EDF\u8BA1"),
            textarea("content", "\u8F93\u5165\u5185\u5BB9")
          ])
        };
