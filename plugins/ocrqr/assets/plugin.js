...
${codeFrame}` : message);
  ...
  // plugins/ocrqr/frontend/plugin.js
  var NAME = "ocrqr";
  function mount(container, ctx) {
    const App = {
      data() {
        return { tab: "ocr", env: null, ocrText: "", ocrLoading: false, qrText: "", qrUrl: "", decResults: [], err: "" };
      },
      methods: {
        async loadEnv() {
          try {
            this.env = await ctx.invoke("ocrqr.ocr.check");
          } catch (e) {
          }
        },
        fileToB64(file) {
          return new Promise((resolve2, reject) => {
            ...
            r.onload = () => resolve2(String(r.result));
            r.onerror = reject;
        ...
        async genQr() {
          ...
          this.err = "";
          try {
            const r = await ctx.invoke("ocrqr.qr.gen", { text: this.qrText, size: 300 });
            this.qrUrl = r && r.url || "";
          } catch (e) {
      ...
      render() {
        ...
        const envBar = env ? h(
          "div",
          { class: "faint", style: "font-size:12px;margin-bottom:8px;" },
          "OCR \u73AF\u5883: " + (env.ok ? "\u5C31\u7EEA" : "\u672A\u5C31\u7EEA") + (env.models ? " \xB7 \u6A21\u578B" : "") + (env.package ? " \xB7 rapidocr" : "")
        ) : null;
        ...
        return h("div", { class: "ocrqr-panel" }, [
          h("div", { class: "section-title" }, "OCR / \u4E8C\u7EF4\u7801"),
          envBar,
