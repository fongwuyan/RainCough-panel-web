...
${codeFrame}` : message);
  ...
  // plugins/webspy/frontend/plugin.js
  var NAME = "webspy";
    ...
    const App = {
      ...
      methods: {
        async search() {
          ...
          this.err = "";
          try {
            const r = await ctx.invoke("webspy.search", { q: this.q });
        ...
        async loadRss() {
          try {
            const r = await ctx.invoke("webspy.rss.list");
            this.rss = r && r.feeds || [];
          } catch (e) {
            this.err = e && e.message || e;
          }
        ...
        async addRss() {
          try {
            await ctx.invoke("webspy.rss.add", { url: this.rssUrl, name: this.rssName });
            this.rssUrl = "";
            this.rssName = "";
            this.loadRss();
          } catch (e) {
        ...
        async delRss(idx) {
          try {
            await ctx.invoke("webspy.rss.delete", { idx });
            this.loadRss();
          } catch (e) {
            this.err = e && e.message || e;
          }
        ...
        async fetchRss(url) {
          try {
            const r = await ctx.invoke("webspy.rss.fetch", { url });
            this.entries = r && r.entries || [];
          } catch (e) {
            this.err = e && e.message || e;
          }
        },
        async readability() {
          ...
          this.loading = true;
          try {
            this.art = await ctx.invoke("webspy.readability", { url: this.artUrl });
          } catch (e) {
            this.err = e && e.message || e;
          }
          this.loading = false;
