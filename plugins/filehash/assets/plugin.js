...
${codeFrame}` : message);
  ...
  // plugins/filehash/frontend/plugin.js
  var NAME = "filehash";
    ...
    const App = {
      ...
      methods: {
        ...
        async dup() {
          this.err = "";
          try {
            this.dup = await ctx.invoke("filehash.da.duplicate", { files: this.files });
          } catch (e) {
            this.err = e && e.message || e;
          }
        },
        async gen() {
          this.err = "";
          try {
            this.gen = await ctx.invoke("filehash.h.generate", { files: this.files, algo: "sha256" });
          } catch (e) {
            this.err = e && e.message || e;
          }
        }
