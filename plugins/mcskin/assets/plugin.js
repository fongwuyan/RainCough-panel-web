...
${codeFrame}` : message);
  ...
  // plugins/mcskin/frontend/plugin.js
  var NAME = "mcskin";
    ...
    const App = {
      ...
      methods: {
        ...
        async convert() {
          ...
          this.err = "";
          try {
            this.result = await ctx.invoke("mcskin.convert", { image: this.img, model: this.model });
          } catch (e) {
        ...
        async t2s() {
          ...
          this.err = "";
          try {
            this.t2s = await ctx.invoke("mcskin.text2skin", { prompt: this.prompt, style: "modern", tone: "any" });
          } catch (e) {
            this.err = e && e.message || e;
          }
          this.pollT2s();
