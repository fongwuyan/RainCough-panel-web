...
${codeFrame}` : message);
  ...
  // plugins/dltool/frontend/plugin.js
  var NAME = "dltool";
    ...
    const App = {
      ...
      methods: {
        ...
        async download() {
          ...
          this.err = "";
          try {
            this.out = await ctx.invoke("dltool.nt.download", { urls: list, pack: true });
          } catch (e) {
        ...
        async split() {
          this.err = "";
          try {
            this.out = await ctx.invoke("dltool.nt.split", { files: this.files, chunkSize: 1 });
          } catch (e) {
            this.err = e && e.message || e;
          }
        },
        ...
        async docCheck() {
          try {
            this.docEnv = await ctx.invoke("dltool.doc.check");
          } catch (e) {
            this.docEnv = null;
          }
        }
