...
${codeFrame}` : message);
  ...
  // plugins/imagetool/frontend/plugin.js
  var NAME = "imagetool";
  function mount(container, ctx) {
    const App = {
      data() {
        return { tab: "similar", simImg: [], procImg: [], similar: null, procResults: [], procOpts: { format: "png", resize: "", quality: "", rotate: "" }, err: "" };
      },
      methods: {
        b64(file) {
        ...
        async similar() {
          if (this.simImg.length < 2) {
            this.err = "\u8BF7\u9009\u4E24\u5F20\u56FE";
            return;
          }
          this.err = "";
          try {
            this.similar = await ctx.invoke("imagetool.similar", { images: this.simImg });
          } catch (e) {
            this.err = e && e.message || e;
          }
        },
        async process() {
          if (!this.procImg.length) {
            this.err = "\u8BF7\u9009\u56FE";
            return;
          }
          this.err = "";
      ...
      render() {
        ...
        const simView = h("div", null, [
          ...
          this.similar ? h("p", null, "\u76F8\u4F3C\u5EA6: " + this.similar.similarity + "% \xB7 " + this.similar.verdict + " (\u6C49\u660E " + this.similar.hamming + ")") : null
        ]);
